...
import com.maybanktask.book_management.util.InputValidator;
...
public class BookController {
    ...
    public ResponseEntity<String> registerBook(@RequestBody BooksourceDto bookDto) throws DataSourceException {
