...
public class BookController {
    ...
    public ResponseEntity<String> registerBook(@RequestBody BooksourceDto bookDto) throws DataSourceException, EmailFormatException {
    ...
    public ResponseEntity<CustomPage<Booksource>> retrieveByCustomerID(
            @RequestParam(defaultValue = "0") int pageNo,
            @RequestParam(defaultValue = "10") int pageSize, @PathVariable String customerId) {
        CustomPage<Booksource> getAllData = dataSourceService.getById(pageNo, pageSize, customerId);
